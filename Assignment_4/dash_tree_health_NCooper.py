"""
Assignment 4: Dash App
Name: Nathan Cooper
"""

"""
Note that Jupyter Notebooks seemed to have issues with Dash, so I used Sypder instead. 
Anyother development environment: Idle, Atom, Emacs, etc 
could have worked equally as well.

Below are the modules I imported to create the Dash App. 
"""
#%%
import pandas as pd
...
"""
Below I downloaded the database from the NYC City Government.

I was not sure what I wanted to do, and computer memory is not an issue so
I downloaded the whole set, and stored it in a data frame named trees.
"""
#%%
...
"""
I the block below I do some data wrangling to get the health codes into a 
more usable from. I simply coverted the discriptions into an ordered number code,
and set the missing values to be the middle catagory, Fair.
"""
#%%
print(trees.shape)
...
"""
In the block below I created a simple histogram for comparison to the one that will appear in the 
Dash App
"""
#%%
trees['health'].hist()
...
"""
I noticed that the x and y data included in the trees set was similar to the x and y
data from the previous project.

I repurposed the code from that project to make datashader images of the trees location
and health to embed into the Dash App.

That proved to be more difficult that I thought, so I retained the code, as the images looked good,
eventhough they were not used in the final product
"""

#%%
#Using some code from assignment 2 to transform the x and y into long and lat
